...
def move_space_object(body, dt):
    ...
    **body** — тело, которое нужно переместить.
    ...
    ax = body.Fx / body.m
    body.x += body.Vx * (dt * 10**(-5)/31536) + 0.5 * ax * (dt * 10**(-5)/31536) ** 2
    body.Vx += ax * (dt * 10**(-5)/31536)

    ay = body.Fy / body.m
    body.y += body.Vy * (dt * 10**(-5)/31536) + 0.5 * ay * (dt * 10**(-5)/31536) ** 2
    body.Vy += ay * (dt * 10**(-5)/31536)
